...
interface Props {
    // navigate?: any,
    textLabelingButtonStore?: LabelingTextButtonStore,
}

// @inject(' textLabelingButtonStore')
// @observer
class LabelingTextButton extends React.Component<Props> {
  constructor(props: any) {
    super(props);
    // this.props.textLabelingButtonStore!.getButtons();
  }

  render() {
    // console.log(this.props.textLabelingButtonStore!.buttonList)
    return (
...
export default LabelingTextButton;
